...
from src.blocks.encoder import BertEncdoer
...
class BertSGM(nn.Module):
    def __init__(self, device):
        ...
        self.attention = SgmAttention(
            encoder_hidden_size=encoder_hidden_size, decoder_hidden_size=self.decoder_hidden_size, att_hidden_size=768)
        self.decoder = RnnDecoder(
            tgt_vocab_size=tgt_vocab_size, hidden_size=self.decoder_hidden_size)
